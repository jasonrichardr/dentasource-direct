// THE ROOM — ported 1:1 from ffcdentalclinic.com/growth-partner on 2026-09-17. Paths, the opener and the thought stream are DSD's; everything else is the FFC script verbatim.
    (function () {
      ...
      var THOUGHTS = [
      // ── THE VOICE, re-cut for DENTIST PRACTITIONERS (2026-09-17 — Jarich: "make it for
      //    dentist practicioners make it funny, meditative, give me 77"). Same law as the
      //    FFC stream: lowercase, short, it NOTICES, asks small and waits. The joke is on
      //    the job, the tools and the room — never on the patient. 77 deep, pinned. ──
        'unclench your jaw. yes, doctor, yours this time. I’ll wait',
        'drop your shoulders. they have been at loupe height since 9 am',
        'your neck has been curved over a molar all day. let it be a neck again',
        'breathe in… hold… out. no patient is waiting on this one',
        'let your hands rest open. they have held a handpiece long enough',
        'your feet on the floor. not the pedal. the floor',
        'nobody is asking you to look at anything for one song',
        'the breath you just took needed no consent form',
        'wherever your mind went, walk it back gently. no chart notes',
        'you are allowed to sit in the chair yourself. it is very comfortable, you should know',
        'stillness is not a cancelled appointment. it is a kept one',
        'this minute has no recall due',
        'let the song carry the heavy cases for a while',
        'the present moment has excellent lighting. you are under it',
        'peace is about one slow breath from here. no anesthesia required',
        'the tide comes in, the tide goes out. saliva knows the rhythm too',
        'soften your face. it has been reassuring people since morning',
        'there is nowhere else you need to be. the schedule can hear you thinking',
        'slow is still forward. ask any endodontist',
        'rest is also part of healing. you tell them that. hear it once',
        'somewhere a curing light is very proud of you',
        'the suction makes that noise on purpose. it is applauding',
        'the little mirror has seen more than any of us. it keeps quiet. professional',
        'the cotton rolls did their best work today. model employees. no complaints',
        'your explorer explored. your excavator excavated. everyone did their job',
        'the compressor sighed the moment you did. it is a team',
        'the chair goes up and down all day and never once asks for a raise',
        'you said open wide about forty times today. you may now close',
        'the assistant handed you the right instrument before you asked. that is love',
        'a bib clip is a tiny miracle. give it a second of thanks',
        'somewhere a floss is being used. tonight, you win',
        'the rubber dam has strong opinions about isolation. so do you',
        'the autoclave is humming your name. it means well',
        'that one patient who actually flosses exists. keep believing',
        'you have explained bruxism today. now stop doing it',
        'the scanner captured a whole arch in seconds. you captured a whole day',
        'the x-ray sees through everything except how tired you are. we do',
        'the gloves come off. so can the day',
        'your loupes have seen a thousand shades of A2',
        'the front desk survived the phone. the phone survived the front desk. peace',
        'a steady hand starts with a steady breath. that is the whole trick',
        'the best restoration is the one nobody notices. like a good breath',
        'margins matter. so do the ones around your day',
        'you see one tooth at a time. tonight, see one breath at a time',
        'precision is patience wearing loupes',
        'the crown fits because you slowed down. so does the evening',
        'the canal goes where it goes. you followed it. that is mastery',
        'every shade you matched today was a small act of care',
        'the occlusion is balanced. now balance you',
        'you make invisible things right for a living. do one for yourself',
        'the tool is new every year. the hands are ancient wisdom',
        'a clean tray is a promise kept before the patient arrives. a clear mind too',
        'you cannot rush an implant. you cannot rush a breath either',
        'the exhale is the polish. it makes everything smoother',
        'slow is smooth. smooth is fast. fast is gentle. you know this chairside',
        'someone slept without pain tonight because of your afternoon',
        'a kid decided dentists are not scary today. that was you',
        'somebody smiled in a photo this week because of your hands',
        'you were the calm in a room that came in scared',
        'your name is said kindly in someone’s kitchen tonight',
        'a patient practised your words at home. you are a teacher too',
        'the whole clinic runs on moments you will not remember. they will',
        'nobody sees the case you saved. the patient lives in it',
        'your team knows the day was heavy. they carried it with you',
        'you showed up for every chair. half of everything good starts there',
        'the practice is a garden. not everything blooms on schedule',
        'a no-show is an unexpected minute. this is it. use it',
        'growth is not loud. it is the same small thing done a little better',
        'the machine only knows what a careful person tells it. you are the person',
        'delegate one thing tomorrow. the clinic will still be standing',
        'you do not need every new toy. you need the ones you will use with love',
        'a good question at the front desk saves a whole chair hour. ask it',
        'the day gets lighter when the team carries it together',
        'the last patient left. the door can be a door again',
        'take the loupes off. the world is allowed to be blurry for one song',
        'tonight, rest. tomorrow, the mouths will still open',
        'you can take this breath with you. it fits in any pocket',
      ];
