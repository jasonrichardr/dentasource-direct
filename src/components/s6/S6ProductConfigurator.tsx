...
const COLORS = [
    { id: "light-blue", name: "Light Blue", hex: "#7E9AB3", image: "/images/products/s6/Unit Color Selection/HX001-51_Light_blue.webp" },
    { id: "orange", name: "Orange", hex: "#E77A41", image: "/images/products/s6/Unit Color Selection/HX001-12_Orange.webp" },
    { id: "ivory", name: "Ivory", hex: "#EBE6D6", image: "/images/products/s6/Unit Color Selection/HX001-31_Ivory.webp" },
    { id: "bordeaux", name: "Bordeaux", hex: "#8A2E3B", image: "/images/products/s6/Unit Color Selection/HX001-78_Bordeaux.webp" },
    { id: "brown", name: "Brown", hex: "#5C4033", image: "/images/products/s6/Unit Color Selection/HX001-97_Brown.webp" },
    { id: "apple-green", name: "Apple Green", hex: "#A8E160", image: "/images/products/s6/Unit Color Selection/HX012-43_Apple_Green_1.webp" },
    { id: "green", name: "Green", hex: "#2E8B57", image: "/images/products/s6/Unit Color Selection/HX012-54_Green_2.webp" },
];
...
const HANDPIECES = [
    {
        ...
        image: "/images/products/s6/Handpiece Placement Choices/hanging.jpg"
    },
    {
        id: "swing",
        title: "Swing-Mounted",
        description: "Versatile ambidextrous design — works for left or right-handed dentists.",
        image: "/images/products/s6/Handpiece Placement Choices/continental.jpg"
    },
    {
        id: "cart",
        title: "Cart-Mounted",
        description: "Standalone mobile cart — maximum flexibility, easy to reposition.",
        image: "/images/products/s6/Handpiece Placement Choices/cart.png"
    }
];
...
export default function S6ProductConfigurator() {
    ...
    const currentAlt =
        activeTab === "color" ? `S6 in ${activeColor.name}` :
            activeTab === "handpiece" ? `S6 ${activeHandpiece.title} delivery` :
                `S6 ${activeUpholstery.name} upholstery`;
