...
const COLORS = [
    { id: "light-blue", name: "Light Blue", hex: "#7E9AB3", image: "/images/products/s6/Unit Color Selection/HX001-51_Light_blue.webp", code: "HX001-51" },
    { id: "orange", name: "Orange", hex: "#E77A41", image: "/images/products/s6/Unit Color Selection/HX001-12_Orange.webp", code: "HX001-12" },
    { id: "ivory", name: "Ivory", hex: "#EBE6D6", image: "/images/products/s6/Unit Color Selection/HX001-31_Ivory.webp", code: "HX001-31" },
    { id: "bordeaux", name: "Bordeaux", hex: "#8A2E3B", image: "/images/products/s6/Unit Color Selection/HX001-78_Bordeaux.webp", code: "HX001-78" },
    { id: "brown", name: "Brown", hex: "#5C4033", image: "/images/products/s6/Unit Color Selection/HX001-97_Brown.webp", code: "HX001-97" },
    { id: "apple-green", name: "Apple Green", hex: "#A8E160", image: "/images/products/s6/Unit Color Selection/HX012-43_Apple_Green_1.webp", code: "HX012-43" },
    { id: "green", name: "Green", hex: "#2E8B57", image: "/images/products/s6/Unit Color Selection/HX012-54_Green_2.webp", code: "HX012-54" },
];
...
const HANDPIECES = [
    {
        ...
        image: "/images/products/s6/Handpiece Placement Choices/Standard.jpg"
    },
    {
        id: "top",
        name: "Over-the-Patient",
        description: "Integrated top-mounted delivery system.",
        image: "/images/products/s6/Handpiece Placement Choices/top.jpg"
    },
    {
        id: "cart",
        name: "Cart-Mounted",
        description: "Mobile standalone cart for maximum flexibility.",
        image: "/images/products/s6/Handpiece Placement Choices/cart.jpg"
    }
];
...
const UPHOLSTERY = [
    {
        ...
        image: "/images/products/s6/Upholstery Selection/pu.webp"
    },
    {
        id: "seamless",
        name: "Seamless Microfiber",
        description: "Sleek, modern, and easy-to-sanitize.",
        image: "/images/products/s6/Upholstery Selection/seamless.webp"
    },
    {
        id: "sewn",
        name: "Sewn Microfiber",
        description: "Supreme tactile comfort with elegant stitching.",
        image: "/images/products/s6/Upholstery Selection/sewn.webp"
    }
];

export default function S6ProductConfigurator() {
        ...
        <section id="configure" className="pt-24 lg:pt-32 pb-0 bg-white relative">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center max-w-3xl mx-auto mb-12 lg:mb-20">
                    ...
                    >
                        Build Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-sky-500">Perfect S6</span>
                    </motion.h2>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
