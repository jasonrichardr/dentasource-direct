...
const items = [
    {
        ...
        description: "Complete chair + casting steel frame base assembly",
    },
    {
        icon: Lightbulb,
        title: "Rolight S Operating Light",
        description: "Philips LED array with infrared control",
    },
    {
        icon: CircleDot,
    ...
    {
        icon: User,
        title: "Multi-Joint Headrest",
        description: "Rock-solid stability, one-handed positioning",
    },
    {
        icon: Sofa,
        title: "Backrest + Seat",
    ...
    },
    {
        ...
        description: "Complete with gas spring, casters & backrest",
        highlight: true,
    },
    {
        icon: Pipette,
...
export default function S6WhatsInTheBox() {
    return (
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                >
                    <p className="text-sm text-gray-500">
                        The 6-way adjustable dentist stool comes included as standard with every S6 — complete with backrest and aluminum alloy base.
                    </p>
                </motion.div>
            </div>
        </section>
