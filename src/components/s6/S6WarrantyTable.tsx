...
export default function S6WarrantyTable() {
    return (
        <section className="py-20 lg:py-24 bg-white relative">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    >
                        We stand behind the engineering of the Roson S6. Every purchase includes our industry-leading 5-year warranty, ensuring total peace of mind for your practice.
                    </motion.p>
                </div>
