...
const specGroups: SpecGroup[] = [
    ...
    },
    {
        ...
        specs: [
            ...
            { name: "Water Supply", value: "Pure water supply" },
        ],
    },
    {
        label: "Air Supply",
    ...
    },
    {
        ...
        specs: [
            ...
            { name: "Right Arm", value: "Rotatable for patient entry/exit" },
            { name: "Starter System", value: "One starter (air/water/electric)" },
        ],
    },
];
...
export default function N1TechSpecs() {
                ...
                <div className="mx-auto max-w-3xl text-center mb-16 lg:mb-20">
                    ...
                    >
                        ...
                        <p className="mt-4 text-base sm:text-lg leading-8 text-gray-600">
                            Everything your technician needs to know about the Classic Model N1.
                        </p>
                    </motion.div>
                </div>
