...
const COLORS = [
    { id: "light-blue", name: "Light Blue", hex: "#7E9AB3", image: "/images/products/s3/Unit Color Selection/HX001-51_Light_blue.webp" },
    { id: "orange", name: "Orange", hex: "#E77A41", image: "/images/products/s3/Unit Color Selection/HX001-12_Orange.webp" },
    { id: "ivory", name: "Ivory", hex: "#EBE6D6", image: "/images/products/s3/Unit Color Selection/HX001-31_Ivory.webp" },
    { id: "bordeaux", name: "Bordeaux", hex: "#8A2E3B", image: "/images/products/s3/Unit Color Selection/HX001-78_Bordeaux.webp" },
    { id: "brown", name: "Brown", hex: "#5C4033", image: "/images/products/s3/Unit Color Selection/HX001-97_Brown.webp" },
    { id: "apple-green", name: "Apple Green", hex: "#A8E160", image: "/images/products/s3/Unit Color Selection/HX012-43_Apple_Green.webp" },
    { id: "green", name: "Green", hex: "#2E8B57", image: "/images/products/s3/Unit Color Selection/HX012-54_Green.webp" },
];
...
const HANDPIECES = [
    {
        id: "standard",
        title: "Standard",
        description: "Classic ergonomic delivery — instruments within easy reach.",
    ...
    },
    {
        ...
        description: "Integrated top-mounted delivery for direct access.",
...
export default function S3ProductConfigurator() {
    ...
    const currentAlt =
        activeTab === "color" ? `S3 in ${activeColor.name}` :
            activeTab === "handpiece" ? `S3 ${activeHandpiece.title} delivery` :
                `S3 ${activeUpholstery.name} upholstery`;
