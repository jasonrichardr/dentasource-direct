...
const specGroups: SpecGroup[] = [
    ...
    },
    {
        ...
        specs: [
            ...
            { name: "Motor", value: "24V DC silent electric motor" },
        ],
    },
    {
        label: "Water System",
    ...
    },
    {
        ...
        specs: [
            ...
            { name: "Operating Light", value: "LED sensor light \u226535,000 lux (autoclavable handle)" },
            { name: "Foot Control", value: "4-way foot control" },
            { name: "Spittoon", value: "Detachable swiveling spittoon" },
        ],
    },
];
...
export default function S3TechSpecs() {
                ...
                <div className="mx-auto max-w-3xl text-center mb-16 lg:mb-20">
                    ...
                    >
                        ...
                        <p className="mt-4 text-base sm:text-lg leading-8 text-gray-600">
                            Everything your technician needs to know about the Best-Selling Model S3.
                        </p>
                    </motion.div>
                </div>
