...
const items = [
    ...
    {
        icon: Lightbulb,
        title: "LED Sensor Operating Light",
        description: "\u226535,000 lux with autoclavable handle",
    },
    {
        icon: CircleDot,
        title: "Detachable Swiveling Spittoon",
        description: "Tool-free removal for thorough cleaning",
    },
    {
        icon: Footprints,
    ...
    },
    {
        ...
        description: "One-handed positioning, safe for all patients",
    },
    {
        icon: Sofa,
        title: "Backrest + Seat",
...
export default function S3WhatsInTheBox() {
    return (
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                >
                    <p className="text-sm text-gray-500">
                        The 6-way adjustable dentist stool comes included as standard with every S3 \u2014 complete with backrest and aluminum alloy base.
                    </p>
                </motion.div>
            </div>
        </section>
