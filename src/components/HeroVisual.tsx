    ...
    return (
        <section className="relative w-full h-[90vh] md:h-screen min-h-[600px] flex items-center justify-center overflow-hidden bg-zinc-900">
            ...
            <div className="absolute inset-0 z-0">
                <Image
                    src="/images/products/n2-pro/N2 Pro Dental Chair/1-1.jpg"
                    alt="Roson Elite Model N2 PRO"
                    fill
            ...
            <div className="container relative z-10 mx-auto px-6 md:px-12 flex flex-col items-start justify-center h-full">
                ...
                >
                    ...
                    <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight mb-6">
                        ROSON Elite Model <br />
                        <span className="text-blue-400">N2 PRO</span>
                    </h1>
                    <p className="text-base sm:text-lg md:text-xl text-gray-100 mb-8 max-w-xl leading-relaxed font-medium">
                        The premium unit trusted by over 80,000 professionals. Featuring an intelligent soft start/stop system and medical-grade color LCD for seamless operation.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-2">
                        <motion.a
                            ...
                            whileTap={{ scale: 0.95 }}
                            href="#configurator"
                            className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-4 sm:py-4 rounded-full font-medium transition-colors text-center text-sm md:text-base"
                        >
                            Configure Yours Now
                        </motion.a>
                        <motion.a
