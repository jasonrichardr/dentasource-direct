...
const items = [
    ...
    },
    {
        ...
        description: "RoLight 8-bead Philips LED",
    },
    {
        icon: CircleDot,
...
export default function A3WhatsInTheBox() {
    return (
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                >
                    <p className="text-sm text-gray-500">
                        The RS06 ergonomic dentist stool comes included as standard with every A3 — complete with armrest, lumbar backrest, and aluminum alloy base.
                    </p>
                </motion.div>
            </div>
        </section>
