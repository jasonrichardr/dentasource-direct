...
const specGroups: SpecGroup[] = [
    ...
    },
    {
        ...
        specs: [
            ...
            { name: "Water Hardness", value: "<25 (<12° dH)" },
    ...
    },
    {
        ...
        specs: [
            ...
            { name: "Operating Light", value: "RoLight 8-bead Philips LED" },
            { name: "Light Arm Capacity", value: "1.5 kg" },
        ],
    },
];
...
export default function A3TechSpecs() {
                ...
                <div className="mx-auto max-w-3xl text-center mb-16 lg:mb-20">
                    ...
                    >
                        ...
                        <p className="mt-4 text-base sm:text-lg leading-8 text-gray-600">
                            Everything your technician needs to know — from the ROSON CE Manual (RSBD-YF-55).
                        </p>
                    </motion.div>
                </div>
