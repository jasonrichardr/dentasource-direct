...
const items = [
    ...
    },
    {
        ...
        description: "RV008-1 Philips LED with dynamic atmosphere lighting",
    },
    {
        icon: CircleDot,
    ...
    },
    {
        ...
        description: "4-way foot controller (IPX4 rated) — DentaSource Exclusive",
        highlight: false,
        exclusive: true,
    },
    {
    ...
    {
        icon: Star,
        title: "RS06 Ergonomic Dentist Stool",
        description: "Complete with gas spring, casters, armrest & backrest",
        highlight: true,
    },
    {
        icon: Pipette,
    ...
    },
    {
        ...
        description: "Polyether tubing, short tube design",
    },
    {
        icon: BookOpen,
...
export default function A3LWhatsInTheBox() {
    return (
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                >
                    <p className="text-sm text-gray-500">
                        The RS06 ergonomic dentist stool comes included as standard with every A3L — complete with armrest, lumbar backrest, and aluminum alloy base.
                    </p>
                </motion.div>
            </div>
        </section>
