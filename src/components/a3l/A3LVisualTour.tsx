...
const ANGLES = [
    { src: "/images/products/dxa3l/main.jpg", title: "A3L Overview" },
    { src: "/images/products/dxa3l/side.jpg", title: "Side Profile" },
    { src: "/images/products/dxa3l/threequarter.jpg", title: "Three-Quarter View" },
    { src: "/images/products/dxa3l/detail.jpg", title: "Detail View" },
    { src: "/images/products/dxa3l/equipment.jpg", title: "Equipment Close-Up" },
];

export default function A3LVisualTour() {
            ...
            <div className="container mx-auto px-6 max-w-7xl">
                <div className="text-center mb-12 lg:mb-16">
                    ...
                    <p className="text-lg text-gray-400 max-w-2xl mx-auto">
                        Fashion-forward design meets precision engineering in every detail of the Model A3L.
                    </p>
                </div>
