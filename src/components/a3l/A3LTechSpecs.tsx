...
const specGroups: SpecGroup[] = [
    ...
    },
    {
        ...
        specs: [
            ...
            { name: "Motor", value: "Whisper-Silent Motor (TIMOTION) with soft start/stop" },
    ...
    },
    {
        ...
        specs: [
            ...
            { name: "EOW-TECH", value: "Optional upgrade" },
            { name: "Warm Water", value: "Optional upgrade" },
        ],
    },
    {
        label: "Air Supply",
    ...
    },
    {
        ...
        specs: [
            ...
            { name: "Handpiece Holder", value: "4-angle adjustable (30°–80°)" },
            { name: "Operating Light", value: "8-Tooth Smile (RV008-1)" },
            { name: "Tubing", value: "Polyether" },
        ],
    },
];
...
export default function A3LTechSpecs() {
