...
export default function A3LProductConfigurator() {
    ...
    const currentAlt =
        activeTab === "color" ? `A3L in ${activeColor.name}` :
            activeTab === "handpiece" ? `A3L ${activeHandpiece.title} delivery` :
                `A3L ${activeUpholstery.name} upholstery`;
