...
const COLORS = [
    { id: "tiffany-blue", name: "Tiffany Blue", hex: "#0ABAB5", image: "/images/products/a3s/Unit Color Selection/Tiffany-blue.webp" },
    { id: "begonia-red", name: "Begonia Red", hex: "#E53935", image: "/images/products/a3s/Unit Color Selection/Begonia-red.webp" },
    { id: "olive-green", name: "Olive Green", hex: "#558B2F", image: "/images/products/a3s/Unit Color Selection/Olive-green.webp" },
    { id: "gray", name: "Gray", hex: "#9E9E9E", image: "/images/products/a3s/Unit Color Selection/Gray.webp" },
    { id: "glaze-blue", name: "Coloured Glaze Blue", hex: "#42A5F5", image: "/images/products/a3s/Unit Color Selection/Coloured-glaze-blue.webp" },
    { id: "orange", name: "Orange", hex: "#F57C00", image: "/images/products/a3s/Unit Color Selection/Orange.webp" },
    { id: "light-green", name: "Light Green", hex: "#A5D6A7", image: "/images/products/a3s/Unit Color Selection/Light-green.webp" },
];
...
const UPHOLSTERY = [
    {
        ...
        name: "Seamless Microfiber (Standard)",
        image: "/images/products/a3s/Upholstery Selection/Seamless-Microfiber.webp",
        description: "Top-tier. No seams = better infection control. 5-year warranty. Standard on A3S."
    },
    {
        id: "pu-leather",
        name: "PU Leather",
        image: "/images/products/a3s/Upholstery Selection/PU-Leather.webp",
        description: "Durable, easy to clean. Standard option."
    },
    {
        id: "sewn-microfiber",
        name: "Sewn Microfiber",
        image: "/images/products/a3s/Upholstery Selection/Sewn-Microfiber.webp",
...
export default function A3SProductConfigurator() {
    ...
    const currentAlt =
        activeTab === "color" ? `A3S in ${activeColor.name}` :
            activeTab === "handpiece" ? `A3S ${activeHandpiece.title} delivery` :
                `A3S ${activeUpholstery.name} upholstery`;
