...
const items = [
    ...
    },
    {
        ...
        description: "Philips LED with breathing lamp & infrared control",
    },
    {
        icon: CircleDot,
    ...
    },
    {
        icon: Sofa,
        title: "Backrest + Seat",
        description: "Seamless microfiber leather as standard",
    },
    {
        icon: Star,
...
export default function A3SWhatsInTheBox() {
    return (
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                >
                    <p className="text-sm text-gray-500">
                        The RS06 ergonomic dentist stool comes included as standard with every A3S \u2014 complete with armrest, lumbar backrest, and aluminum alloy base.
                    </p>
                </motion.div>
            </div>
        </section>
