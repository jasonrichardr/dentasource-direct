...
const features = [
    {
        title: "8-Way Dynamic Adjustability",
        description: "Supports diverse body types with full range of ergonomic adjustments.",
    },
    {
        title: "5\u00b0 Forward Tilt",
        description: "Maintains natural lumbar lordosis for optimal access posture during procedures.",
    },
    {
...
export default function A3SErgonomicsSection() {
    return (
                ...
                <div className="mx-auto max-w-3xl text-center mb-16 lg:mb-20">
                    ...
                    >
                        ...
                        <p className="mt-4 text-base sm:text-lg leading-8 text-gray-600">
                            Musculoskeletal disorders are the #1 cause of disability in dentistry. The RS06 stool is designed to prevent them.
                        </p>
                    </motion.div>
                </div>
                    ...
                    >
                        <div className="relative aspect-square rounded-3xl overflow-hidden shadow-2xl bg-[#EBEBEB] border border-gray-100">
                            <Image
                                ...
                                alt="RS06 Ergonomic Dentist Stool"
                                fill
