...
export default function N2PlusWhatsInTheBox() {
    return (
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                >
                    <p className="text-sm text-gray-500">
                        The RS03 ergonomic dentist stool comes included as standard with every N2+ — complete with integrated armrest, backrest, and wide cast aluminum base.
                    </p>
                </motion.div>
            </div>
        </section>
