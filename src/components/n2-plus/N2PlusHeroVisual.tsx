...
export default function N2PlusHeroVisual() {
    return (
        <section className="relative w-full h-[90vh] md:h-screen min-h-[600px] flex items-center justify-center overflow-hidden bg-zinc-900">
            ...
            <div className="absolute inset-0 z-0">
                <Image
                    src="/images/products/n2-plus/N2+ Dental Chair/N2_Angle.jpg"
                    alt="Roson Classic Model N2+"
                    fill
