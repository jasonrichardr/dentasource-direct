...
const specGroups: SpecGroup[] = [
    ...
    },
    {
        ...
        specs: [
            ...
            { name: "Max Patient Load", value: "150 kg" },
            { name: "Motor", value: "24V DC Whisper-Silent Motor" },
        ],
    },
    {
        label: "Water System",
        specs: [
            ...
            { name: "Pure Water Bottles", value: "2\u00d7 1L" },
            { name: "Disinfectant Water", value: "Independent supply" },
        ],
    },
    {
        label: "Air Supply",
    ...
    },
    {
        ...
        specs: [
            ...
            { name: "Dentist Table", value: "650\u00d7300mm" },
            { name: "Handpiece Holder", value: "5-position" },
            { name: "Spittoon", value: "Ceramic, 180\u00b0 rotatable" },
            { name: "X-Ray Viewer", value: "LED backlit, built-in" },
            { name: "Tissue Box", value: "5-in-1, dual-layer" },
        ],
    },
];
...
export default function N2PlusTechSpecs() {
                ...
                <div className="mx-auto max-w-3xl text-center mb-16 lg:mb-20">
                    ...
                    >
                        ...
                        <p className="mt-4 text-base sm:text-lg leading-8 text-gray-600">
                            Everything your technician needs to know about the Classic Model N2+.
                        </p>
                    </motion.div>
                </div>
