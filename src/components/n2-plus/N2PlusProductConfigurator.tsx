...
const COLORS = [
    ...
    { id: "bordeaux", name: "Bordeaux", hex: "#800020", image: "/images/products/n2-plus/Unit Color Selection/Bordeaux_2.webp" },
...
export default function N2PlusProductConfigurator() {
    ...
    const currentAlt =
        activeTab === "color" ? `N2+ in ${activeColor.name}` :
            activeTab === "handpiece" ? `N2+ ${activeHandpiece.title} delivery` :
                `N2+ ${activeUpholstery.name} upholstery`;
