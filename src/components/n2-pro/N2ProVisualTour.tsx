...
const ANGLES = [
    ...
    { src: "/images/products/n2-pro/N2 Pro Dental Chair/3-1.jpg", title: "Left Side" },
    { src: "/images/products/n2-pro/N2 Pro Dental Chair/4-1.jpg", title: "Right Side" },
    { src: "/images/products/n2-pro/N2 Pro Dental Chair/5-1.jpg", title: "Top View" },
    { src: "/images/products/n2-pro/N2 Pro Dental Chair/6-1.jpg", title: "Rear View" },
];

export default function N2ProVisualTour() {
            ...
            <div className="container mx-auto px-6 max-w-7xl">
                <div className="text-center mb-12 lg:mb-16">
                    ...
                    <p className="text-lg text-gray-400 max-w-2xl mx-auto">
                        Precision engineering meets elegant design in every detail of the Elite Model N2 PRO.
                    </p>
                </div>
