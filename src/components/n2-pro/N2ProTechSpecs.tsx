...
const specGroups: SpecGroup[] = [
    ...
    },
    {
        ...
        specs: [
            ...
            { name: "Motor", value: "Whisper-Silent Motor with intelligent soft start/stop" },
    ...
    },
    {
        ...
        specs: [
            ...
            { name: "Disinfection", value: "Independent disinfectant water supply" },
            { name: "Pure Water Supply", value: "2\u00d7 1L bottles" },
        ],
    },
    {
        label: "Air Supply",
    ...
    },
    {
        label: "Physical",
        specs: [
            { name: "Dentist Table", value: "650\u00d7315mm" },
            { name: "Handpiece Holders", value: "5-position with scaler/motor pre-positions" },
            { name: "Spittoon", value: "180\u00b0 rotatable ceramic" },
...
export default function N2ProTechSpecs() {
                ...
                <div className="mx-auto max-w-3xl text-center mb-16 lg:mb-20">
                    ...
                    >
                        ...
                        <p className="mt-4 text-base sm:text-lg leading-8 text-gray-600">
                            Everything your technician needs to know — complete N2 PRO specifications.
                        </p>
                    </motion.div>
                </div>
