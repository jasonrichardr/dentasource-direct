...
export default function N2ProErgonomicsSection() {
    return (
                ...
                <div className="mx-auto max-w-3xl text-center mb-16 lg:mb-20">
                    ...
                    >
                        ...
                        <p className="mt-4 text-base sm:text-lg leading-8 text-gray-600">
                            Musculoskeletal disorders are the #1 cause of disability in dentistry. The RS03 stool is designed to prevent them.
                        </p>
                    </motion.div>
                </div>
