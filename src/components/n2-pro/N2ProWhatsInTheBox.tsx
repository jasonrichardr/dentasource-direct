...
const items = [
    ...
    },
    {
        ...
        description: "Rolight S with Philips LEDs",
    },
    {
        icon: CircleDot,
        title: "Ceramic Cuspidor",
        description: "180\u00b0 rotatable with flushing system",
    },
    {
        icon: Footprints,
    ...
    },
    {
        ...
        description: "Wide cast aluminum base, integrated armrest & backrest, noiseless nylon wheels",
        highlight: true,
        badge: "Included Free",
    },
    {
        ...
        description: "Stainless steel syringe, strong + weak suction",
    },
    {
        icon: Cable,
...
export default function N2ProWhatsInTheBox() {
    return (
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                >
                    <p className="text-sm text-gray-500">
                        The RS03 ergonomic dentist stool comes included as standard with every N2 PRO — complete with integrated armrest, backrest, and wide cast aluminum base.
                    </p>
                </motion.div>
            </div>
        </section>
