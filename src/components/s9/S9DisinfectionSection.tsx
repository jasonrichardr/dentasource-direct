...
export default function S9DisinfectionSection() {
    return (
                ...
                <div className="mx-auto max-w-3xl text-center mb-16 lg:mb-20">
                    ...
                    >
                        ...
                        <p className="mt-4 text-lg sm:text-xl leading-8 text-emerald-100/70">
                            99.9999% Bacteria Elimination \u2014 powered by electrolyzed oxidizing water technology built directly into the S9 waterline system.
                        </p>
                    </motion.div>
                </div>
