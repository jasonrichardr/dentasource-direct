...
export const metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: '/images/og/og-news-2026-09-05c.jpg', width: 1200, height: 630, alt: 'News from the floor: installs, conventions, training and launches from DentaSource Direct' }],
  },
  twitter: {
    ...
    description:
      'Installs, conventions, Training Center courses and every ROSON and Denjoy launch, written from the floor and dated to the day.',
    images: ['/images/og/og-news-2026-09-05c.jpg'],
  },
};
