...
import ScrollCardStack from '@/components/Home/ScrollCardStack';
...
export default function Home() {
  return (
    <main className="relative bg-black font-sans w-full overflow-x-hidden">

      <ScrollCardStack>
        {/* ── CARD 1: HERO & MARQUEE ─────────────────────────────────── */}
        <div className="w-full h-full overflow-hidden flex flex-col bg-[#1E3A2E] bg-gradient-to-b from-[#182e24] to-[#12241c]">
        ...
        <div className="w-full h-full overflow-hidden bg-[#fbfbfd] flex flex-col justify-center border-t border-black/5">
        ...
        {/* ── CARD 3: X-RAYS & ENDO ────────────────────── */}
        <div className="w-full h-full overflow-hidden bg-white flex flex-col justify-center border-t border-black/5">
        ...
        {/* ── CARD 4: MICROSCOPES ────────────────────── */}
        <div className="w-full h-full overflow-hidden bg-black flex flex-col justify-center border-t border-white/10">
      ...
      {/* ── SECTION 5: WHY US ────────────────────────────────── */}
      <div className="w-full bg-white flex flex-col justify-center pt-24 pb-12">
        <section className={`section ${styles.whySection} flex-1 flex flex-col justify-center`}>
      ...
      {/* ── CONCLUDING CONTENT (Services, Trade-in, CTA) ──────────────── */}
