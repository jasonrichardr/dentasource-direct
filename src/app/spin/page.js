...
export const metadata = {
  ...
  openGraph: {
    title: 'Spin to Win at NADTI 2026 · DentaSource Direct',
    description: 'Booth 034 and 035, Halls 1 to 3, SMX Convention Center, September 22 to 24. Pre-register and reserve your spin.',
    url: 'https://dentasourcedirect.com/spin',
    images: [{ url: 'https://dentasourcedirect.com/images/og/spin-nadti-2026-a.png', width: 1200, height: 630 }],
  },
  twitter: { card: 'summary_large_image', images: ['https://dentasourcedirect.com/images/og/spin-nadti-2026-a.png'] },
